...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'users_index' => [['id'], ['_controller' => 'App\\Controller\\UsersController::index'], [], [['text', '/users'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin']], [], []],
        'users_new' => [['id'], ['_controller' => 'App\\Controller\\UsersController::new'], [], [['text', '/users/new'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin']], [], []],
        'users_show' => [['id'], ['_controller' => 'App\\Controller\\UsersController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/user']], [], []],
        'users_edit' => [['id'], ['_controller' => 'App\\Controller\\UsersController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/user']], [], []],
        'users_delete' => [['id'], ['_controller' => 'App\\Controller\\UsersController::delete'], [], [['text', '/user'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin']], [], []],
